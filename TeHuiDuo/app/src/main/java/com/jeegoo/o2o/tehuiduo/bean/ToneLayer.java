package com.jeegoo.o2o.tehuiduo.bean;
...
public class ToneLayer {
    ...
    private Slider mSaturationBar;

    /**
     * 色相
     */
    private TextView mHue;
    private Slider mHueBar;

    /**
     * 亮度
     */
    private TextView mLum;
    private Slider mLumBar;
    ...
    private ArrayList<Slider> mSliders = new ArrayList<Slider>();
    ...
    private void init(Context context) {
        ...
        mSaturationBar = new Slider(context);
        mHueBar = new Slider(context);
        mLumBar = new Slider(context);

        mSliders.add(mSaturationBar);
        mSliders.add(mHueBar);
        mSliders.add(mLumBar);

        for (int i = 0, size = mSliders.size(); i < size; i++) {
            Slider seekBar = mSliders.get(i);
            seekBar.setValue(50,true);
 //           seekBar.setPosition(50,false);
